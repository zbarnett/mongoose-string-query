module.exports = exports = function apiQueryPlugin (schema) {
  ...
  schema.statics.apiQuery = function(rawParams, pageOptions, cb) {
    ...
    if (pageOptions) {
      skip = (parseInt(pageOptions.page, 10) - 1) * pageOptions.perPage;
      query.skip(skip).limit(pageOptions.perPage);
    }
